...
/* IAR defined some of the intrinsics internally starting with 6.20.x, so we have to selectively define them */
#define IAR_INTERNAL_INTRINSICS_VER 6020000  // IAR __VER__ value for release 6.20.0
...
/* define the following intrinsics only for IAR less than 6.20 */
#if (__VER__ < IAR_INTERNAL_INTRINSICS_VER)
...
#endif /* IAR_INTERNAL_INTRINSICS_VER */
