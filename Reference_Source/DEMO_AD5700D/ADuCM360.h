...
#ifndef __ADUCM360_H__
#define __ADUCM360_H__
...
// --------------------------  ADUCM360 Specific Interrupt Numbers  ------------------------------
  WUT_IRQn                          = 0,    /*!<   0  WUT                              */
...
/* ADCCON[BUFPOWN] - Negative buffer power */
#define ADCCON_BUFPOWN_MSK             (0x1   << 17 )
#define ADCCON_BUFPOWN                 (0x1   << 17 )
#define ADCCON_BUFPOWN_DIS             (0x0   << 17 ) /* DIS                      */
#define ADCCON_BUFPOWN_EN              (0x1   << 17 ) /* EN                       */

/* ADCCON[BUFPOWP] - Positive buffer power */
#define ADCCON_BUFPOWP_MSK             (0x1   << 16 )
#define ADCCON_BUFPOWP                 (0x1   << 16 )
#define ADCCON_BUFPOWP_DIS             (0x0   << 16 ) /* DIS                      */
#define ADCCON_BUFPOWP_EN              (0x1   << 16 ) /* EN                       */
...
#define T0CON_EVENT_T0                 (0xB   << 8  ) /* T0 - Timer0              */
#define T0CON_EVENT_T1                 (0xC   << 8  ) /* T1 - Timer1              */
#define T0CON_EVENT_ADC0               (0xD   << 8  ) /* ADC0 - ADC0              */
#define T0CON_EVENT_ADC1               (0xE   << 8  ) /* ADC1 - ADC1              */
#define T0CON_EVENT_SINC2              (0xF   << 8  ) /* SINC2 - SINC2            */
...
#define T1CON_EVENT_FEE                (0x0   << 8  ) /* FEE                      */
#define T1CON_EVENT_COM                (0x1   << 8  ) /* COM                      */
...
#define T1CON_EVENT_DMASPI1TX          (0x7   << 8  ) /* DMASPI1TX                */
#define T1CON_EVENT_DMASPI1RX          (0x8   << 8  ) /* DMASPI1RX                */
#define T1CON_EVENT_DMACOMTX           (0x9   << 8  ) /* DMACOMTX                 */
#define T1CON_EVENT_DMACOMRX           (0xA   << 8  ) /* DMACOMRX                 */
#define T1CON_EVENT_DMAI2CSTX          (0xB   << 8  ) /* DMAI2CSTX                */
#define T1CON_EVENT_DMAI2CSRX          (0xC   << 8  ) /* DMAI2CSRX                */
#define T1CON_EVENT_DMAI2CMTX          (0xD   << 8  ) /* DMAI2CMTX                */
#define T1CON_EVENT_DMAI2CMRX          (0xE   << 8  ) /* DMAI2CMRX                */
#define T1CON_EVENT_DMADAC             (0xF   << 8  ) /* DMADAC                   */
...
/* ADC0CON[BUFPOWN] - Negative buffer power */
...
#define ADC0CON_BUFPOWN_DIS            (0x0   << 17 ) /* DIS                      */
#define ADC0CON_BUFPOWN_EN             (0x1   << 17 ) /* EN                       */

/* ADC0CON[BUFPOWP] - Positive buffer power */
...
#define ADC0CON_BUFPOWP_DIS            (0x0   << 16 ) /* DIS                      */
#define ADC0CON_BUFPOWP_EN             (0x1   << 16 ) /* EN                       */
...
/* ADCCFG[BOOST15] - Boost the Vbias current source ability by 15 times */
#define ADCCFG_BOOST15_BBA             (*(volatile unsigned long *) 0x426003B0)
#define ADCCFG_BOOST15_MSK             (0x1   << 12 )
#define ADCCFG_BOOST15                 (0x1   << 12 )
#define ADCCFG_BOOST15_DIS             (0x0   << 12 ) /* DIS                      */
#define ADCCFG_BOOST15_EN              (0x1   << 12 ) /* EN                       */
...
#define          ADC1PRO                                    (*(volatile unsigned short int *) 0x400300C4)
#define          ADC1DAT                                    (*(volatile unsigned long      *) 0x400300C8)
#define          TEMPREF                                    (*(volatile unsigned long      *) 0x400300DC)
#endif // (__NO_MMR_STRUCTS__==1)
...
/* ADC1CON[BUFPOWN] - Negative buffer power */
...
#define ADC1CON_BUFPOWN_DIS            (0x0   << 17 ) /* DIS                      */
#define ADC1CON_BUFPOWN_EN             (0x1   << 17 ) /* EN                       */

/* ADC1CON[BUFPOWP] - Positive buffer power */
...
#define ADC1CON_BUFPOWP_DIS            (0x0   << 16 ) /* DIS                      */
#define ADC1CON_BUFPOWP_EN             (0x1   << 16 ) /* EN                       */
...
/* ADCSCFG1[BOOST15] - Boost the Vbias current source ability by 15 times */
#define ADCSCFG1_BOOST15_BBA           (*(volatile unsigned long *) 0x426013B0)
#define ADCSCFG1_BOOST15_MSK           (0x1   << 12 )
#define ADCSCFG1_BOOST15               (0x1   << 12 )
#define ADCSCFG1_BOOST15_DIS           (0x0   << 12 ) /* DIS                      */
#define ADCSCFG1_BOOST15_EN            (0x1   << 12 ) /* EN                       */
...
/* Reset Value for TEMPREF*/
#define TEMPREF_RVAL                   0x0 

/* TEMPREF[VALUE] -  */
#define TEMPREF_VALUE_MSK              (0xFFFFFFFF << 0  )
// ------------------------------------------------------------------------------------------------
// -----                                        ADCSTEP                                        -----
// ------------------------------------------------------------------------------------------------
